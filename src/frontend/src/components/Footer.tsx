        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/70 font-body mb-4 max-w-md">
              The world&apos;s first truly decentralized social platform built
              on the Internet Computer Protocol. Empowering users with complete
              data ownership and direct monetization.
            </p>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-white/50 font-body text-sm mb-4 md:mb-0">
              © 2025 deCentra. Building the future of decentralized social
